      ...
      <header className="np-fin-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', width: '100%' }}>
          ...
          <div>
            ...
            <h1 className="np-section-title" style={{ fontSize: '1.75rem', fontWeight: 700, margin: 0 }}>Riwayat Pendapatan</h1>
          </div>
        </div>
      </header>

      <section className="np-glass-card" style={{ padding: '1.5rem', background: 'linear-gradient(135deg, rgba(204, 255, 128, 0.15) 0%, rgba(204, 255, 128, 0.02) 100%)', borderColor: 'rgba(204, 255, 128, 0.2)' }}>
        <p className="np-saldo-label" style={{ marginBottom: '0.5rem' }}>Total Pendapatan</p>
        <h2 className="text-primary font-stat-value" style={{ fontSize: '2.25rem', margin: 0 }}>
      ...
      <section className="transactions-section" style={{ marginTop: '0.5rem' }}>
        {isLoading && sortedTransactions.length === 0 ? (
          ...
          <div className="np-glass-card text-center py-12 flex flex-col items-center justify-center">
            <Inbox size={48} strokeWidth={1.5} className="text-muted mb-3" opacity={0.5} />
            <p className="text-muted" style={{ margin: 0 }}>Belum ada pendapatan bulan ini</p>
          </div>
        )}
      </section>
